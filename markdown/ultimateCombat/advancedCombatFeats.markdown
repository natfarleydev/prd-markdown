...
[Dodge](/pathfinderRPG/prd/feats.html#_dodge), [Weapon Focus](/pathfinderRPG/prd/feats.html#_weapon-focus) with selected thrown weapon
...
[Deathless Initiate\*](#deathless-initiate)
...
May use *[dimension door](/pathfinderRPG/prd/spells/dimensionDoor.html#_dimension-door)*or abundant step as part of a charge action
...
Arcane Strike, base attack bonus +11, ability to cast *[dispel magic](/pathfinderRPG/prd/spells/dispelMagic.html#_dispel-magic)*
...
    [Haunted Gnome Shroud\*](#haunted-gnome-shroud)
...
With successful [Stunning Fist](/pathfinderRPG/prd/feats.html#_stunning-fist), you may cripple opponent's mouth
...
Cha 13, [Persuasive](/pathfinderRPG/prd/feats.html#_persuasive)
...
Sneak attack class feature, [Critical Focus](/pathfinderRPG/prd/feats.html#_critical-focus), any critical feat, base attack bonus +9
...
Use [Stunning Fist](/pathfinderRPG/prd/feats.html#_stunning-fist) against pinned opponents
...
Spend a swift action to make a [Bluff](/pathfinderRPG/prd/skills/bluff.html#_bluff) check to feint
...
Grit class feature or [Amateur Gunslinger](#amateur-gunslinger), [Sleight of Hand](/pathfinderRPG/prd/skills/sleightOfHand.html#_sleight-of-hand) 1 rank
...
[Dragon Style](#dragon-style), [Stunning Fist](/pathfinderRPG/prd/feats.html#_stunning-fist), [Acrobatics](/pathfinderRPG/prd/skills/acrobatics.html#_acrobatics) 5 ranks
...
    [Snapping Turtle Shell\*](#snapping-turtle-shell)
...
[Point-Blank Shot](/pathfinderRPG/prd/feats.html#_point-blank-shot), base attack bonus +6
...
**Special**: Taking this feat allows you to qualify for the [Elemental Fist](/pathfinderRPG/prd/advanced/advancedFeats.html#_elemental-fist) feat (*Advanced Player's Guide* 158) even if you do not meet that feat's prerequisites. If you do not meet that feat's prerequisites, you must choose one of the damage types that feat offers, and you can use only that damage type with your [Elemental Fist](/pathfinderRPG/prd/advanced/advancedFeats.html#_elemental-fist) attacks until you meet the feat's normal prerequisites. A monk with this feat can use [Elemental Fist](/pathfinderRPG/prd/advanced/advancedFeats.html#_elemental-fist) as if he were a monk of the four winds (*Advanced Player's Guide* 112).
...
**Prerequisites**: Con 15, Wis 17, Efreeti Style, [Efreeti Stance](#efreeti-stance), Elemental Fist\*\*, [Improved Unarmed Strike](/pathfinderRPG/prd/feats.html#_improved-unarmed-strike), base attack bonus +13 or monk level 11th.

**Benefit**: While using Efreeti Style, as a standard action, you can spend two [Elemental Fist](/pathfinderRPG/prd/advanced/advancedFeats.html#_elemental-fist) (*Advanced Player's Guide* 158) attempts to unleash a 15-foot cone-shaped burst of flame. Creatures caught in the cone take your unarmed strike damage plus the fire damage from your [Elemental Fist](/pathfinderRPG/prd/advanced/advancedFeats.html#_elemental-fist) and catch on fire. A successful Reflex save (DC 10 + 1/2 your character level + your Wis modifier) reduces the damage by half and prevents a target from catching on fire.
...
**Prerequisite**: [Skilled Driver](#skilled-driver) with the selected vehicle type.
...
**Prerequisites**: Grit class feature or the [Amateur Gunslinger](#amateur-gunslinger) feat.

**Benefit**: You gain 2 extra grit points at the start of each day, and your maximum grit increases by 2.

**Normal**: If you are a gunslinger, you gain your Wisdom modifier in grit points at the start of each day, which is also your maximum grit. If you have the [Amateur Gunslinger](#amateur-gunslinger) feat, you gain 1 grit point at the start of each day, and your maximum grit is equal to your Wisdom modifier.
...
## Felling [Smash](/pathfinderRPG/prd/advanced/advancedFeats.html#_smash) (Combat) {#felling-smash}
...
**Prerequisites**: Str 15, Int 3; naga, serpentfolk, or creature that has the constrict special attack; [Ability Focus](/pathfinderRPG/prd/monsters/monsterFeats.html#_ability-focus) (constrict); [Final Embrace](#final-embrace); base attack bonus +6.
...
Few creatures can survive the crushing horror of your [Final Embrace](#final-embrace).

**Prerequisites**: Str 17, Int 3; naga, serpentfolk, or creature that has the constrict special attack; [Ability Focus](/pathfinderRPG/prd/monsters/monsterFeats.html#_ability-focus) (constrict); [Final Embrace](#final-embrace); [Final Embrace Horror](#final-embrace-horror); base attack bonus +9.
...
**Prerequisites**: [Improved Rending Fury](#improved-rending-fury), [Rending Fury](#rending-fury), base attack bonus +12, rend special attack.
...
**Prerequisites**: Dex 17, [Improved Snap Shot](#improved-snap-shot), [Point-Blank Shot](/pathfinderRPG/prd/feats.html#_point-blank-shot), [Rapid Shot](/pathfinderRPG/prd/feats.html#_rapid-shot), [Snap Shot](#snap-shot), base attack bonus +12.
...
**Prerequisites**: [Improved Whip Mastery](#improved-whip-mastery), [Weapon Focus](/pathfinderRPG/prd/feats.html#_weapon-focus) (whip), [Whip Mastery](#whip-mastery), base attack bonus +8.
...
*Crafting Ammunition*: You can craft bullets, pellets, and black powder for a cost in raw materials equal to 10% of the price. If you have at least 1 rank in [Craft](/pathfinderRPG/prd/skills/craft.html#_craft) (alchemy), you can craft alchemical cartridges for a cost in raw materials equal to half the price of the cartridge. At your GM's discretion, you can craft metal cartridges for a cost in raw materials equal to half the cost of the cartridge. Crafting bullets, black powder, or cartridges takes 1 day of work for every 1,000 gp of ammunition (minimum 1 day).
...
**Benefit**: You add *[haunted fey aspect](/pathfinderRPG/prd/ultimateCombat/spells/hauntedFeyAspect.html#_haunted-fey-aspect)* (page 230) to your list of gnome magic spell-like abilities, and you can use this spell-like ability twice per day.
...
**Prerequisites**: Cha 13, gnome magic racial trait, [Haunted Gnome](#haunted-gnome), [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (arcana) 3 ranks.
...
Further, while you are under the effect of *[haunted fey aspect](/pathfinderRPG/prd/ultimateCombat/spells/hauntedFeyAspect.html#_haunted-fey-aspect)* (page 230)*,* you can discharge that spell as a free action after you hit an opponent with a charge attack or score a critical hit against an opponent. If you do, that opponent becomes shaken for 1 round.
...
**Prerequisites**: Cha 13, gnome magic racial trait, [Haunted Gnome](#haunted-gnome), [Haunted Gnome Assault](#haunted-gnome-assault), [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (arcana) 6 ranks.

**Benefit**: You gain another independent use of your gnome magic like that which [Haunted Gnome Assault](#haunted-gnome-assault) grants. Further, while you are under the effect of *[haunted fey aspect](/pathfinderRPG/prd/ultimateCombat/spells/hauntedFeyAspect.html#_haunted-fey-aspect),* you also have concealment (20% miss chance) against an opponent until that opponent deals you damage.
...
**Prerequisites**: Expert trainer class feature (*Advanced Player's Guide* 33), [Ride](/pathfinderRPG/prd/skills/ride.html#_ride) 6 ranks.
...
## Impact Critical Shot (Combat, Critical) {#impact-critical-shot}
...
**Prerequisites**: [Back to Back](#back-to-back), [Perception](/pathfinderRPG/prd/skills/perception.html#_perception) 5 ranks.
...
**Prerequisites**: [Charging Hurler](#charging-hurler), [Point-Blank Shot](/pathfinderRPG/prd/feats.html#_point-blank-shot).

**Benefit**: When you use [Charging Hurler](#charging-hurler), your target can be at any range up to your weapon's maximum range. If your target is within 30 feet, you gain a +2 bonus on damage rolls.

**Normal**: Using [Charging Hurler](#charging-hurler) requires you to end your movement within 30 feet of your opponent.

## Improved Cleaving Finish (Combat) {#improved-cleaving-finish}

You can cut down many opponents in a single strike.

**Prerequisites**: Str 13, [Cleave](/pathfinderRPG/prd/feats.html#_cleave), [Cleaving Finish](#cleaving-finish), [Great Cleave](/pathfinderRPG/prd/feats.html#_great-cleave), [Power Attack](/pathfinderRPG/prd/feats.html#_power-attack), base attack bonus +6.

**Benefit**: You can use [Cleaving Finish](#cleaving-finish) any number of times per round.

## Improved Devastating Strike (Combat) {#improved-devastating-strike}

The fury and power channeled through your attack is enough to kill a lesser being outright.

**Prerequisites**: [Devastating Strike](#devastating-strike), [Vital Strike](/pathfinderRPG/prd/feats.html#_vital-strike), base attack bonus +13.

**Benefit**: Whenever you use [Vital Strike](/pathfinderRPG/prd/feats.html#_vital-strike), [Improved Vital Strike](/pathfinderRPG/prd/feats.html#_improved-vital-strike), or [Greater Vital Strike](/pathfinderRPG/prd/feats.html#_greater-vital-strike), you gain a bonus on attack rolls to confirm a critical hit equal to the bonus on damage rolls you gain from [Devastating Strike](#devastating-strike).

## Improved Feint Partner (Combat, Teamwork) {#improved-feint-partner}
...
## Improved Impaling Critical (Combat, Critical) {#improved-impaling-critical}
...
**Prerequisites**: [Rending Fury](#rending-fury), base attack bonus +9, rend special attack.
...
**Prerequisites**: Dex 15, [Point-Blank Shot](/pathfinderRPG/prd/feats.html#_point-blank-shot), [Rapid Shot](/pathfinderRPG/prd/feats.html#_rapid-shot), [Snap Shot](#snap-shot), [Weapon Focus](/pathfinderRPG/prd/feats.html#_weapon-focus), base attack bonus +9.

**Benefit**: You threaten an additional 10 feet with [Snap Shot](#snap-shot).
...
**Prerequisites**: [Diehard](/pathfinderRPG/prd/feats.html#_diehard), [Endurance](/pathfinderRPG/prd/feats.html#_endurance), [Stalwart](#stalwart), base attack bonus +11.

**Benefit**: Double the DR you gain from [Stalwart](#stalwart), to a maximum of DR 10/—.

## Improved Two-Weapon Feint (Combat) {#improved-two-weapon-feint}
...
**Prerequisites**: [Weapon Focus](/pathfinderRPG/prd/feats.html#_weapon-focus) (whip), [Whip Mastery](#whip-mastery), base attack bonus +5.
...
**Prerequisites**: [Improved Unarmed Strike](/pathfinderRPG/prd/feats.html#_improved-unarmed-strike), Janni Style, [Janni Tempest](#janni-tempest), [Acrobatics](/pathfinderRPG/prd/skills/acrobatics.html#_acrobatics) 8 ranks, [Perform](/pathfinderRPG/prd/skills/perform.html#_perform) (dance) 8 ranks.
...
**Prerequisites**: Int 13, [Kirin Strike](#kirin-strike), Kirin Style, [Improved Unarmed Strike](/pathfinderRPG/prd/feats.html#_improved-unarmed-strike), [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (arcana) 12 ranks, [Knowledge](/pathfinderRPG/prd/skills/knowledge.html#_knowledge) (dungeoneering, local, nature, planes, or religion) 5 ranks.
...
**Prerequisites**: Dex 13, grit class feature or [Amateur Gunslinger](#amateur-gunslinger) feat, [Dodge](/pathfinderRPG/prd/feats.html#_dodge), [Mobility](/pathfinderRPG/prd/feats.html#_mobility), base attack bonus +4.
...
**Prerequisites**: [Heal](/pathfinderRPG/prd/skills/heal.html#_heal) 9 ranks, [Improved Unarmed Strike](/pathfinderRPG/prd/feats.html#_improved-unarmed-strike), Mantis Style, [Mantis Wisdom](#mantis-wisdom), [Stunning Fist](/pathfinderRPG/prd/feats.html#_stunning-fist).
...
**Prerequisites**: Con 15, Wis 17, Elemental Fist\*\*, [Marid Spirit](#marid-spirit), Marid Style, [Improved Unarmed Strike](/pathfinderRPG/prd/feats.html#_improved-unarmed-strike), base attack bonus +13 or monk level 11th.

**Benefit**: While using Marid Style, as a standard action, you can spend two [Elemental Fist](/pathfinderRPG/prd/advanced/advancedFeats.html#_elemental-fist) (*Advanced Player's Guide* 158) attempts to unleash a 30-foot line of frigid water. Creatures caught in the line take your unarmed strike damage plus the cold damage from your [Elemental Fist](/pathfinderRPG/prd/advanced/advancedFeats.html#_elemental-fist) attack and are entangled in ice as per the [Marid Spirit](#marid-spirit) feat. A successful Reflex save (DC 10 + 1/2 your character level + your Wis modifier) reduces the damage by half and prevents a target from becoming entangled.
...
**Prerequisites**: [Performing Combatant](#performing-combatant) or at least three performance feats, base attack bonus +6.
...
**Special**: If you have the [Double Bane](#double-bane) feat, you can imbue each weapon you wield with either bane or menacing. No single weapon can have both.
...
**Prerequisites**: Wis 13, [Improved Unarmed Strike](/pathfinderRPG/prd/feats.html#_improved-unarmed-strike), [Monkey Moves](#monkey-moves), Monkey Style, [Stunning Fist](/pathfinderRPG/prd/feats.html#_stunning-fist), [Acrobatics](/pathfinderRPG/prd/skills/acrobatics.html#_acrobatics) 11 ranks, [Climb](/pathfinderRPG/prd/skills/climb.html#_climb) 11 ranks.
...
**Prerequisites**: Int 13, [Blind-Fight](/pathfinderRPG/prd/feats.html#_blind-fight), [Combat Expertise](/pathfinderRPG/prd/feats.html#_combat-expertise), [Moonlight Stalker](#moonlight-stalker), [Bluff](/pathfinderRPG/prd/skills/bluff.html#_bluff) 6 ranks, darkvision or low-light vision racial trait.
...
**Prerequisites**: Int 13, [Blind-Fight](/pathfinderRPG/prd/feats.html#_blind-fight), [Combat Expertise](/pathfinderRPG/prd/feats.html#_combat-expertise), [Improved Feint](/pathfinderRPG/prd/feats.html#_improved-feint), [Moonlight Stalker](#moonlight-stalker), [Moonlight Stalker Feint](#moonlight-stalker-feint), [Bluff](/pathfinderRPG/prd/skills/bluff.html#_bluff) 9 ranks, darkvision or low-light vision racial trait.
...
**Prerequisites**: [Bonebreaker](#bonebreaker), [Greater Grapple](/pathfinderRPG/prd/feats.html#_greater-grapple), [Improved Grapple](/pathfinderRPG/prd/feats.html#_improved-grapple), [Improved Unarmed Strike](/pathfinderRPG/prd/feats.html#_improved-unarmed-strike), [Jawbreaker](#jawbreaker), [Stunning Fist](/pathfinderRPG/prd/feats.html#_stunning-fist), [Heal](/pathfinderRPG/prd/skills/heal.html#_heal) 12 ranks.
...
**Prerequisites**: Dex 15, [Exotic Weapon Proficiency](/pathfinderRPG/prd/feats.html#_exotic-weapon-proficiency) (net), [Net Adept](#net-adept), [Two-Weapon Fighting](/pathfinderRPG/prd/feats.html#_two-weapon-fighting).
...
**Prerequisites**: [Exotic Weapon Proficiency](/pathfinderRPG/prd/feats.html#_exotic-weapon-proficiency) (net), [Net Adept](#net-adept), base attack bonus +3.
...
**Prerequisites**: [Exotic Weapon Proficiency](/pathfinderRPG/prd/feats.html#_exotic-weapon-proficiency) (net), [Net Adept](#net-adept), [Net Maneuvering](#net-maneuvering), base attack bonus +6.
...
Your *[faerie fire](/pathfinderRPG/prd/spells/faerieFire.html#_faerie-fire)* not only illuminates your foes, but it also shows you their weaknesses.

**Prerequisites**: [Improved Unarmed Strike](/pathfinderRPG/prd/feats.html#_improved-unarmed-strike), [Nightmare Fist](#nightmare-fist), [Nightmare Weaver](#nightmare-weaver), [Stunning Fist](/pathfinderRPG/prd/feats.html#_stunning-fist), [Heal](/pathfinderRPG/prd/skills/heal.html#_heal) 5 ranks, ability to cast *[faerie fire](/pathfinderRPG/prd/spells/faerieFire.html#_faerie-fire)*.

**Benefit**: While a *[faerie fire](/pathfinderRPG/prd/spells/faerieFire.html#_faerie-fire)* you have cast (not one cast from a spell completion or spell trigger item) outlines an opponent, the DC for that opponent to resist your [Stunning Fist](/pathfinderRPG/prd/feats.html#_stunning-fist) attempts increases by +2. If you hit an opponent with a [Stunning Fist](/pathfinderRPG/prd/feats.html#_stunning-fist) attempt, and that opponent fails her saving throw, you can render the target shaken for 1d2 rounds plus 1 round for every 5 by which the opponent failed her save.

## Nightmare Weaver (Combat) {#nightmare-weaver}

You can use your ability to create magical darkness to terrorize enemies.

**Prerequisites**: [Improved Unarmed Strike](/pathfinderRPG/prd/feats.html#_improved-unarmed-strike), [Nightmare Fist](#nightmare-fist), [Intimidate](/pathfinderRPG/prd/skills/intimidate.html#_intimidate) 2 ranks, ability to cast *[darkness](/pathfinderRPG/prd/spells/darkness.html#_darkness)*.

**Benefit**: By spending a full-round action to cast *[darkness](/pathfinderRPG/prd/spells/darkness.html#_darkness)*, you can also make [Intimidate](/pathfinderRPG/prd/skills/intimidate.html#_intimidate) checks to demoralize all foes in the spell's initial area.
...
**Prerequisites**: Grit class feature or [Amateur Gunslinger](#amateur-gunslinger) feat, [Bluff](/pathfinderRPG/prd/skills/bluff.html#_bluff) 4 ranks.
...
**Prerequisites**: Wis 15, [Combat Reflexes](/pathfinderRPG/prd/feats.html#_combat-reflexes), [Improved Unarmed Strike](/pathfinderRPG/prd/feats.html#_improved-unarmed-strike), [Panther Claw](#panther-claw), Panther Style.
...
## Performance Weapon Mastery (Combat) {#performance-weapon-mastery}
...
**Benefit**: If you have been prone since the end of your last turn, you can ignore the penalty the prone condition imposes on ranged attack rolls you make using a crossbow or firearm with which you have [Weapon Focus](/pathfinderRPG/prd/feats.html#_weapon-focus).

**Special**: If you have the [Prone Slinger](#prone-slinger) feat, [Weapon Focus](/pathfinderRPG/prd/feats.html#_weapon-focus) (sling) satisfies this feat's [Weapon Focus](/pathfinderRPG/prd/feats.html#_weapon-focus) prerequisite, and you can apply this feat's benefit to attack rolls you make using a sling with which you have [Weapon Focus](/pathfinderRPG/prd/feats.html#_weapon-focus).
...
**Special:** You can gain [Rapid Reload](#rapid-reload) multiple times. Each time you take the feat, it applies to a new type of crossbow or a new type of firearm.
...
**Prerequisites**: Sneak attack +3d6, [Sap Adept](#sap-adept).
...
**Prerequisites**: Grit class feature or [Amateur Gunslinger](#amateur-gunslinger) feat, [Sleight of Hand](/pathfinderRPG/prd/skills/sleightOfHand.html#_sleight-of-hand) 1 rank.

**Benefit**: Spend 1 grit point while in combat to recover either 1 bullet and 1 dose of black powder or 1 alchemical cartridge from a hidden stash on your person that you had, until now, forgotten about. If the bullet and black powder or the alchemical cartridges are normal shot, you do not need to pay for the ammunition. If you want to recover any other kind of ammunition, you must pay for it with gold pieces from your character's wealth. The grit cost of this deed cannot be decreased by the [Signature Deed](#signature-deed) feat, the true grit class feature, or any other similar effect that reduces the number of grit points you spend to use a deed. You also gain a +4 bonus on any [Sleight of Hand](/pathfinderRPG/prd/skills/sleightOfHand.html#_sleight-of-hand) checks made while gambling.
...
**Prerequisites**: [Siege Engineer](#siege-engineer), [Profession](/pathfinderRPG/prd/skills/profession.html#_profession) (siege engineer) 5 ranks.
...
**Prerequisites**: [Combat Reflexes](/pathfinderRPG/prd/feats.html#_combat-reflexes), [Improved Unarmed Strike](/pathfinderRPG/prd/feats.html#_improved-unarmed-strike), [Snake Sidewind](#snake-sidewind), Snake Style, [Acrobatics](/pathfinderRPG/prd/skills/acrobatics.html#_acrobatics) 6 ranks, [Sense Motive](/pathfinderRPG/prd/skills/senseMotive.html#_sense-motive) 9 ranks.
...
**Prerequisites**: [Snapping Turtle Clutch](#snapping-turtle-clutch), Snapping Turtle Style, [Improved Grapple](/pathfinderRPG/prd/feats.html#_improved-grapple), [Improved Unarmed Strike](/pathfinderRPG/prd/feats.html#_improved-unarmed-strike), base attack bonus +5 or monk level 5th.
...
**Prerequisites**: [Combat Expertise](/pathfinderRPG/prd/feats.html#_combat-expertise), [Improved Bull Rush](/pathfinderRPG/prd/feats.html#_improved-bull-rush), [Improved Trip](/pathfinderRPG/prd/feats.html#_improved-trip), [Improved Unarmed Strike](/pathfinderRPG/prd/feats.html#_improved-unarmed-strike), *Ki* Throw.
...
**Prerequisites**: Dex 13, [Point-Blank Shot](/pathfinderRPG/prd/feats.html#_point-blank-shot), [Rapid Shot](/pathfinderRPG/prd/feats.html#_rapid-shot), [Snap Shot](#snap-shot), [Two-Weapon Fighting](/pathfinderRPG/prd/feats.html#_two-weapon-fighting), base attack bonus +6.
...
## Target of Opportunity (Combat, Teamwork) {#target-of-opportunity}
...
**Prerequisites**: [Improved Unarmed Strike](/pathfinderRPG/prd/feats.html#_improved-unarmed-strike), [Power Attack](/pathfinderRPG/prd/feats.html#_power-attack), [Tiger Claws](#tiger-claws), Tiger Style, base attack bonus +9 or monk level 8th.
